export interface MenuItem {
  ...
  const timeList = ['Good morning', 'Good late morning', 'Good afternoon', 'Good late afternoon', 'Good evening'];
  ...
  export const treeRouter = (list: MenuItem[]) => {
    ...
    console.log(menus,'menus constructed')
    return menus
  };
