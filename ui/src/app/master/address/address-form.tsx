import { CreateAddressDto, CreateEmployeeDto } from '@gatex/shared-models';
import { AddressService, DepartmentService, DesignationService, EmployeeService, SupplierService, UnitService } from '@gatex/shared-services';
