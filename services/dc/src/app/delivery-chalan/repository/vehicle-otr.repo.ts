...
@Injectable()
export class VehicleOTRRepo extends Repository<VehicleOTREntity> {
    constructor(@InjectRepository(VehicleOTREntity) private vehicleOTRRepo: Repository<VehicleOTREntity>
    ) {
        super(vehicleOTRRepo.target, vehicleOTRRepo.manager, vehicleOTRRepo.queryRunner);
    }
